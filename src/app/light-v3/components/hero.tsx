  ...
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center px-6 py-24 text-center">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-visible">
        <div className="h-[600px] w-[800px] rounded-full bg-accent blur-[120px]" />
      </div>

      <div className="relative z-10 flex flex-col items-center max-w-4xl mx-auto">
        {/* Avatar and Badge */}
        <div className="mb-8 flex flex-col items-center">
          <div className="relative h-20 w-20 overflow-hidden rounded-full border-4 border-card shadow-sm">
            <Image
          ...
          <div className="mt-4 flex items-center gap-1.5 rounded-full border border-border bg-card px-3 py-1 text-sm font-medium shadow-sm text-card-foreground">
            <svg
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
        ...
        {/* Headline */}
        <h1 className="font-serif text-5xl md:text-7xl tracking-tight text-primary mb-6">
          Your Design Partner
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mb-24">
          <button className="h-12 rounded-full bg-primary px-8 text-primary-foreground hover:opacity-90 transition-all flex items-center">
          ...
          <Link
            href="/light"
            className="bg-card text-card-foreground px-8 py-4 rounded-full font-medium border border-border hover:bg-muted transition-all shadow-sm no-underline"
          >
            Light Mood
          </Link>
        </div>
