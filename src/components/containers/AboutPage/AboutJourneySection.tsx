      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative aspect-4/5 w-full max-w-md mx-auto lg:mx-0 rounded-2xl overflow-hidden border border-border/40 shadow-2xl shadow-orange-500/10">
              {/* Placeholder for now, can be replaced with a real image of Munim or a coding setup */}
              <div className="absolute inset-0 bg-secondary/50 flex items-center justify-center">
                <Image
                  src="/images/about.avif" // Reusing the about image for consistency, or use a new one
          ...
          >
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-foreground mb-6">
                Beyond Just{" "}
                <span className="text-orange-500">Writing Code</span>
              </h2>
            </div>

            <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
              <p>
                I started my journey by building simple websites and learning
                how modern frontend frameworks work. As I worked on more
                real-world projects, I realized something important:
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <li className="flex items-center gap-2 text-foreground font-medium p-3 rounded-lg bg-orange-500/5 border border-orange-100 dark:border-orange-500/10">
              ...
              <p>
                ...
                applications, where frontend performance and visibility go hand
                in hand.
              </p>

              <p>
                Today, I focus on building production-ready web applications
                that are engineered for{" "}
                <strong className="text-foreground">
